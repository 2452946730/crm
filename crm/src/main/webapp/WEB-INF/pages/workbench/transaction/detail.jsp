...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${stageList}" var="s">
			<c:if test="${tran.tranNO > s.orderNo}">
			...
			<c:if test="${tran.tranNO == s.orderNo}">
				<span class="glyphicon glyphicon-map-marker mystage" data-toggle="popover" data-placement="bottom" data-content="${tran.stage}" style="color: #90F790;"></span>
				-----------
			</c:if>
			<c:if test="${tran.tranNO < s.orderNo}">
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<c:forEach items="${remarkList}" var="r">
			<div class="remarkDiv" id="div_${tran.id}" style="height: 60px;">
				<img title="${tran.owner}" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5>${r.noteContent}</h5>
					<font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"> ${r.editFlag == 0?r.createTime:r.editTime} 由${r.editFlag == 0?r.createBy+"创建":r.editBy+"修改"}</small>
					<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
						<a class="myHref" remarkId="${r.id}" name="editA" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="myHref" remarkId="${r.id}" name="deleteA" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
					</div>
				</div>
			</div>
		</c:forEach>
